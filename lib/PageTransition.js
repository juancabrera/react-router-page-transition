...
var PageTransition = function (_React$Component) {
  ...
  _createClass(PageTransition, [{
        ...
        _this3.forceUpdate(function () {
          ...
          var start = function start() {
            if (newChildDom.classList.contains('transition-item')) {
              timeout = _this3.props.timeout || DEFAULT_TIMEOUT;
    ...
    value: function render() {
      ...
      childs.push(_react2.default.Children.map(this.state.child1, function (element) {
        return _react2.default.cloneElement(element, { ref: 'child1' });
      }));
      if (this.state.nextChild === 1) {
        childs.unshift(_react2.default.Children.map(this.state.child2, function (element) {
          return _react2.default.cloneElement(element, { ref: 'child2' });
        }));
      } else {
        childs.push(_react2.default.Children.map(this.state.child2, function (element) {
          return _react2.default.cloneElement(element, { ref: 'child2' });
        }));
      }
      ...
      return _react2.default.createElement(
        'div',
        { className: 'transition-wrapper YOYOOO' },
        childs
      );
    }
  }]);
